...
pub struct AuthResponse {
    ...
    pub user: ::core::option::Option<super::common::User>,
...
pub mod auth_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/auth.Auth/GetCurrentUser");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("auth.Auth", "GetCurrentUser"));
            self.inner.unary(req, path, codec).await
        }
    }
}
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/auth.Auth/GetCurrentUser" => {
                    #[allow(non_camel_case_types)]
                    struct GetCurrentUserSvc<T: Auth>(pub Arc<T>);
                    impl<
                        T: Auth,
                    ...
                    for GetCurrentUserSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Auth>::get_current_user(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
