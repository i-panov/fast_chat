...
pub mod files_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn upload(
            ...
            let path = http::uri::PathAndQuery::from_static("/files.Files/Upload");
            let mut req = request.into_streaming_request();
            req.extensions_mut().insert(GrpcMethod::new("files.Files", "Upload"));
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/files.Files/Download");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("files.Files", "Download"));
        ...
        pub async fn get_metadata(
            ...
            tonic::Response<super::super::common::FileMetadata>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/files.Files/GetMetadata");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("files.Files", "GetMetadata"));
...
pub mod files_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/files.Files/GetMetadata" => {
                    #[allow(non_camel_case_types)]
                    struct GetMetadataSvc<T: Files>(pub Arc<T>);
                    impl<T: Files> tonic::server::UnaryService<super::FileRequest>
                    for GetMetadataSvc<T> {
                        type Response = super::super::common::FileMetadata;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Files>::get_metadata(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "files.Files";
